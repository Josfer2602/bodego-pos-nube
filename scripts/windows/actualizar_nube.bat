...
ssh -t root@178.156.196.20 "cd /var/www/app-ventas && git config --global --add safe.directory /var/www/app-ventas && git pull origin master && bash scripts/server/deploy.sh"
